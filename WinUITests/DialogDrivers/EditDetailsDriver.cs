...
{
    public sealed class EditDetailsDriver : DriverBase
    {
        ...
        public static EditDetailsDriver FindFromParent(AutomationElement parent)
        {
            return new EditDetailsDriver(parent);
        }
        ...
        /// <summary>
        /// Select OK button to save any changes - validate success by ensuring dialog closes
        /// </summary>
        /// <exception cref="ApplicationException">Edit Details failed</exception>
        public void SelectOKVerifySuccess()
        {
            ...
            {
                throw new ApplicationException("Edit Details failed using name '" + GetPropBagValue("name") + "'");
            }
        }
        ...
        protected override string DialogId { get { return "EditItemDialog"; } }
        ...
        {
            UIAUtility.WaitForElementEnabledWithTimeout(_okCtl, AddinTestUtility.WebServiceResponsePopulateTimeout);
        }
    }
}
